...
print("|\n-------------------------------------------------------------------------------------------------------\nNOTE: sometimes the video may not be available or you might get a 404 or 403 error code, 99% of the time these errors are from youtube, so if you get a 404 error you should try donwloading again and it should work\n-------------------------------------------------------------------------------------------------------\n|")
